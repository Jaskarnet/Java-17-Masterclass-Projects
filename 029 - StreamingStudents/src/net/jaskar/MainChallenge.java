...
public class MainChallenge {
    public static void main(String[] args) {
        ...
        Course cgj = new Course("JGAME", "Creating Games in Java");
        ...
        System.out.printf("Average percentage completed for all students (Java Masterclass): %.2f%%%n", average);
        ...
        System.out.printf("Number of hard-working students: %d%n", goodStudents.size());

        // Sort by the longest enrolled students who are still active, 10 of them are going to get my new course for a trial run
